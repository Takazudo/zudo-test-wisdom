...
### [暗号・ハッシュテスト](/pj/zudo-test-wisdom/ja/docs/real-world-patterns/crypto-testing)

既知解（ハードコードされたダイジェスト）による暗号テスト、入力型をまたぐ等価性（文字列 vs `ArrayBuffer`）、「決定論的」なテストでは見逃すエンコーディングバグの捕捉。

### [remark/rehypeプラグインのテスト](/pj/zudo-test-wisdom/ja/docs/real-world-patterns/remark-rehype-plugin-testing)

ユニットテスト向けのmdastツリーファクトリーに加え、`UPDATE_FIXTURES`による再生成と言語をまたぐパリティオラクルを備えたゴールデンフィクスチャのコーパス。

### [定期再試験 & 夜間試験](/pj/zudo-test-wisdom/ja/docs/real-world-patterns/scheduled-re-exam)
