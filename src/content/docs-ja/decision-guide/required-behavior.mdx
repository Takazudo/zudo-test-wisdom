...
ルール7があなたを拘束するのは、赤いPRの**作者**としてです。逆の役割 — あなたがマージゲートを運用していて、redが自分の所有していないテストのものである場合 — には、専用の手続きがあります：[ゲートオペレーターのプレイブック](../real-world-patterns/deflaking-recipe.mdx#自分のものではない赤いci-—-ゲートオペレーターのプレイブック)。
