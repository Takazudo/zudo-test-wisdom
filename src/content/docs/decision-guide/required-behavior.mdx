...
Rule 7 binds you as the **author** of the red PR. The inverse role — you are operating a merge gate, and the red is on a test you don't own — has its own procedure: [the gate operator's playbook](../real-world-patterns/deflaking-recipe.mdx#red-ci-you-don-t-own-—-the-gate-operator-s-playbook).
