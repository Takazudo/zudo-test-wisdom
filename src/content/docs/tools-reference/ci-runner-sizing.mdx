...
| e2e specs time out under load | Assume flaky, add retries | Diagnose first: CPU starvation → 2→4vCPU (Rule 3); connection starvation → fix the app/serving layer, resizing won't help |
