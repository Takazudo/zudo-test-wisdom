...
- **Project Recipes** -- Pages organized around a repo or project shape, not a single tool: backend, Tauri, remark/rehype plugins, built-site integrity, and dependency replacement
- **CI Operations** -- Running suites across CI, deploys, and releases: environment-tiered testing, smoke tests, scheduled re-exam, branch strategy, publishing, runner sizing, CI-skip markers and merge hygiene, and gate optimization
...
3. Reference the pattern categories -- [Tool Patterns](../tool-patterns/index.mdx), [Project Recipes](../project-recipes/index.mdx), [CI Operations](../ci-operations/index.mdx), and [Test Integrity](../test-integrity/index.mdx) -- for production-tested configurations
