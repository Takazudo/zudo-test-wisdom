...
- **CI Operations** -- Running suites across CI, deploys, and releases: environment-tiered testing, smoke tests, scheduled re-exam, branch strategy, publishing, runner sizing, and CI-skip markers and merge hygiene
