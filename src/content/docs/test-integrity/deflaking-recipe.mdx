...
See also: [Playwright Patterns](../tool-patterns/playwright-patterns.mdx) for the full Playwright setup patterns, and [Execution Tiers](../decision-guide/execution-tiers.mdx) for when a flaky test is a topology problem rather than a timing problem.
