...
- [Fail-Closed Live Proofs and Evidence Contracts](../test-integrity/live-proof-evidence-contracts.mdx) -- the one fenced exception to the never-mutate rule: a release proof whose operation *is* a write, and the three verdicts it owes in return
