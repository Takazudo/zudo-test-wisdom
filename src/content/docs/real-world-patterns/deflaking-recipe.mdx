...
In the worked case, 50 tests shared by both shards went **710s → 1054s** — the regression was invisible in any single test (each still passed on retry) and unmistakable in the aggregate.
