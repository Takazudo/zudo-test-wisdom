...
![Stage A: first canvas showing the placed image fitting inside the clip rectangle](/pj/zudo-test/img/docs/level-6/stage-a-canvas-with-clip-and-image.png)
...
![Stage B: second canvas where the image's ratio to the canvas does not match Stage A](/pj/zudo-test/img/docs/level-6/stage-b-canvas-image-mismatched.png)
