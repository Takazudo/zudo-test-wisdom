...
Level 1 is the right choice when you are confident the bug is in logic, not in rendering. Visibility and CSS doubts always route to Level 5, per [CSS Always Needs Level 5](../decision-guide/quick-decision.mdx#key-principle-css-always-needs-level-5) -- reserve Level 4 for multi-step interaction flows, not visibility questions.
...
| Element not showing on screen | No -- use Level 5 |
